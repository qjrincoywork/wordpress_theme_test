...
class UberMenuWalker extends Walker_Nav_Menu {
	...
	function display_element( $element, &$children_elements, $max_depth, $depth, $args, &$output ) {
		...
		if( isset( $element->duplicate ) && $element->duplicate ) $el_id = $element->ID; // Use the altered ID if this is a duplicate element so that we get the child index correct
